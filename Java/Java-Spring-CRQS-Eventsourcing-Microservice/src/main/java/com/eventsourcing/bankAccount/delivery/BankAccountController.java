...
public class BankAccountController {
    ...
    @PostMapping(path = "/withdraw/{aggregateId}")
    public ResponseEntity<Void> withdrawAmount(@Valid @RequestBody WithdrawAmountRequestDTO dto, @PathVariable String aggregateId) {
        commandService.handle(new WithdrawAmountCommand(aggregateId, dto.amount()));
        return ResponseEntity.ok().build();
    }
